...
In order to create your vector database, you'll need to create a .env file in your root directory containing your HuggingFace Token so that you can use hugging face embeddings.
